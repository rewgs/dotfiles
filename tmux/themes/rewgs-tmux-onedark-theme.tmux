...
# edited right -- no clock or date
# set "status-right" "#[fg=$onedark_visual_grey,bg=$onedark_black]#[fg=$onedark_visual_grey,bg=$onedark_visual_grey]#[fg=$onedark_white, bg=$onedark_visual_grey]${status_widgets} #[fg=$onedark_green,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$onedark_green,bold] #h #[fg=$onedark_yellow, bg=$onedark_green]#[fg=$onedark_red,bg=$onedark_yellow]"
# set "status-right" "#[fg=$onedark_visual_grey,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_white,bg=$onedark_visual_grey,bold] #h #[fg=$onedark_yellow, bg=$onedark_blue]#[fg=$onedark_red,bg=$onedark_yellow]"
set "status-right" "#{prefix_highlight}#[fg=$onedark_visual_grey,bg=$onedark_black,nobold,nounderscore,noitalics]#[fg=$onedark_white,bg=$onedark_visual_grey] #h"
...
set "status-left" "#[fg=$onedark_white,bg=$onedark_visual_grey] #S #{prefix_highlight}#[fg=$onedark_visual_grey,bg=$onedark_black,nobold,nounderscore,noitalics]"

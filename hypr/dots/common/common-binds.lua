...
-- Fine
hl.bind(mainMod .. " + SHIFT + ALT + h",   hl.dsp.window.resize({ x = -10, y =   0, relative = true }), { repeating = true })
hl.bind(mainMod .. " + SHIFT + ALT + l",   hl.dsp.window.resize({ x =  10, y =   0, relative = true }), { repeating = true })
hl.bind(mainMod .. " + SHIFT + ALT + k",   hl.dsp.window.resize({ x =   0, y = -10, relative = true }), { repeating = true })

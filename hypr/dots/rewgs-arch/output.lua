...
---@class Monitor
---@field position string -- center, left, or right
---@field output string
---@field mode string
local monitor = {}
...
hl.monitor({
	...
	position = "-2160x" .. y_offset,
	scale = 1.3333334,
	transform = 3,
}) -- looks like 1920x2160
-- hl.monitor({ output = "DP-3", mode = "2560x2880@59.98", position = "-2160x0", scale = 1.3333334, transform = 3 }) -- looks like 2160x1920
...
-- LG DualUp (right)
-- hl.monitor({ output = "DP-2", mode = "2560x2880@59.98", position = "3008x0", scale = 1.3333334 }) -- looks like 2160x1920
hl.monitor({
	output = "DP-2",
	mode = "2560x2880@59.98",
	position = "3008x" .. y_offset,
	scale = 1.3333334,
	transform = 3,
}) -- looks like 2160x1920

	--[=====[
	This is the most of the config from https://github.com/mbbill/undotree/blob/master/plugin/undotree.vim#L15
	Can implement all these options once I figure out how best to wrap it in lua.
	...
	if !exists('g:undotree_WindowLayout')
	    " uncomment one line to pick a style above

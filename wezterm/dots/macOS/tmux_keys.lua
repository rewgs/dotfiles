...
local keys = {
    ...
    { key = 'j',    mods = 'SUPER',         action = wezterm.action.DisableDefaultAssignment },
    { key = 'k',    mods = 'SUPER',         action = wezterm.action.DisableDefaultAssignment },
    { key = 'l',    mods = 'SUPER',         action = wezterm.action.DisableDefaultAssignment },

    ---------------------------------------------------------------------------
    -- meta
    ---------------------------------------------------------------------------
    { key = 'w',    mods = 'SUPER|SHIFT',           action = actions.meta.close_tab },
    -- { key = 'r',    mods = 'SUPER',           action = actions.meta.reload_config },

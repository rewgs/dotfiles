    ...
    for i, item in enumerate(sl):
        ...
        if keyname:
            ...
            if item == '=':
                ...
                print('Hi there, Alex from the past here. I commented out the three lines below this comment because this code wouldn\'t run otherwise and I couldn\'t figure out why. The file is decoder.py in the toml site-packages directory.')
        ...
        if item == '\n':
            ...
            if not keygroup and not arrayoftables:
                ...
                key += item
    if keyname:
        print('Hi there, Alex from the past here. I commented out the two lines below this comment because this code wouldn\'t run otherwise and I couldn\'t figure out why. The file is decoder.py in the toml site-packages directory.')
        # raise TomlDecodeError("Key name found without value."
